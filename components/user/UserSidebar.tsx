...
import {
  Home, Navigation, Radio, Activity, Wallet,
  User as UserIcon, LogOut, Zap, ChevronRight, Star,
} from 'lucide-react'
...
export function UserSidebar() {
  ...
  const displayName = userProfile?.full_name || user?.user_metadata?.full_name || 'You'
    ...
    <aside className="fixed left-3 top-3 bottom-3 w-[272px] bg-white/90 backdrop-blur-xl border border-white/30 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.08)] flex flex-col z-50 rounded-[32px] overflow-hidden">
      <div className="px-6 pt-6 pb-4 space-y-5 flex-shrink-0">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 bg-primary rounded-2xl flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-primary/20">
            Z
          </div>
          <div>
